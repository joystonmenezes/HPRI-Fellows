  ...
  return (
    <>
      ...
      <main id="main" className="mx-auto max-w-content space-y-8 px-4 py-10">
        ...
        <Section
          id="presentations"
          title="Presentations: Fellows Seminars & Tuesday Talks"
        ...
        <Section
          ...
          intro={assignments.intro}
        >
          <SubmitAssignments rows={assignmentRows} />
        </Section>

        {/* Capstone */}
        {capstone.published !== false ? (
        ...
        <Section id="contacts" title="Important Contacts and Addresses">
          ...
          <div className="mt-8 border-t border-neutral-200 pt-6">
            ...
            <p className="mt-1 text-sm text-neutral-600">
              Questions about the program? Use the form below — we reply by
              email, and you’ll get a copy of your message.
            </p>
            <div className="mt-5">
              <ContactForm />
            </div>
